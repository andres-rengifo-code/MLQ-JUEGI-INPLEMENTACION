...
/*
 * Clase encargada de ejecutar la simulación del algoritmo
...
public class MLQScheduler {
    ...
    private double averageTAT;
     ...
     //Ejecuta la simulación utilizando el esquema seleccionado.
    ...
    private void executeRoundRobin(List<Process> queue, int quantum){
        ...
        for(int i= 0 ; i<quantum;i++){
            ...
            if(process.getQueue()==2&& !queue1.isEmpty()){break;}
    ...
    /*
     * Calcula WT, CT, RT y TAT de todos los procesos.
     */
    ...
    //METODO encragado de devolver los procesos listos
